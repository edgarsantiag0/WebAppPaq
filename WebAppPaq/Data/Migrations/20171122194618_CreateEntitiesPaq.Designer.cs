...
namespace WebAppPaq.Data.Migrations
{
    ...
    [Migration("20171122194618_CreateEntitiesPaq")]
    partial class CreateEntitiesPaq
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WebAppPaq.Models.Paq.Factura", b =>
                {
                    ...
                    b.Property<int?>("Sucursal1Id");

                    b.Property<int?>("Sucursal2Id");
                    ...
                    b.HasIndex("Sucursal1Id");

                    b.HasIndex("Sucursal2Id");
            ...
            modelBuilder.Entity("WebAppPaq.Models.Paq.Factura", b =>
                {
                    b.HasOne("WebAppPaq.Models.Paq.Sucursal", "Sucursal1")
                        .WithMany("Factura1")
                        .HasForeignKey("Sucursal1Id");

                    b.HasOne("WebAppPaq.Models.Paq.Sucursal", "Sucursal2")
                        .WithMany("Factura2")
                        .HasForeignKey("Sucursal2Id");
                });
        }
    }
}
